    ...
    >
      ...
      <div className="relative flex grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          ...
          <Logo className="hidden h-9 w-auto fill-slate-700 lg:block dark:fill-purple-100" />
        </Link>
      </div>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:grow">
        ...
        <Link href="https://github.com/acton-ai/acton-ai" className="group" aria-label="GitHub">
