...
import blurPurpleImage from '@/images/blur-purple.png'
...
const tabs = [
  { name: 'acton-ai.toml', isActive: true },
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-violet-200 via-purple-400 to-violet-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Agentic AI on the actor model.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Build intelligent AI agents with message-passing actors. Async,
                resilient, and composable.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Get started</Button>
                <Button href="https://github.com/acton-ai/acton-ai" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#110A1F]/80 ring-1 ring-white/10 backdrop-blur-sm">
                    ...
                    {tabs.map((tab) => (
                      <div
                        ...
                        className={clsx(
                          ...
                          tab.isActive
                            ? 'bg-linear-to-r from-purple-400/30 via-purple-400 to-purple-400/30 p-px font-medium text-purple-300'
                            : 'text-slate-500',
                        )}
                      >
                        <div
