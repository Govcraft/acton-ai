...
pub mod prelude {
    ...
    pub use crate::audit::{
        ...
        AuditHealthState, AuditOutcome, ChainBreak, ChainBreakKind, ChainHead, InvocationRecord,
        Redactor, TurnAuditOutcome, TurnRecord, DEFAULT_REDACT_PATTERNS, GENESIS_HASH,
    };
